...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\DecValTok{1}\FloatTok{-0.9973}\NormalTok{)}\OperatorTok{*}\DecValTok{1000000}  \CommentTok{#milyon fırsattaki hata sayısı }
\end{Highlighting}
\end{Shaded}
...
\textbf{II. Nesil (Generation II):} 1994-2000 yılları, I. nesilin devamı olarak ürün tasarımlarında iyileştirme ve maliyetlerin azaltılması odak noktası olmuştur. Örn: General Elektrik

\textbf{III. Nesil (Generation III):} 2000 li yıllar ve sonrası, geçmiş nesillere ek olarak değer yaratma (yeni ürünler üretilmesi, pazarın genişletilmesi, hisse senetlerindeki değer artışı ) odak noktası olmuştur.
